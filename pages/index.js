    ...
    <div className="px-8 mt-10" >
      <Head>
        ...
        <div className="mx-auto lg:w-3/5 lg:flex lg:flex-row lg:h-auto  " >
          <img className="rounded-tr-md rounded-tl-md h-48 lg:h-auto lg:w-2/5 lg:rounded-bl-md lg:rounded-tr-none w-full" src="/images/drawers.jpg" />
          <div className="bg-white p-8 rounded-bl-md rounded-br-md lg:rounded-bl-none lg:rounded-tr-md" >
            ...
            <p className="text-sm text-gray-600 mt-4" >Ever been in a room and felt like something was missing? Perhaps it felt slightly bare and uninviting. I've got some simple tips to help you make any room felt complete</p>
            <div className="flex items-center mt-8" >
            <div className="flex items-center" >
                <img className="h-10 w-10 rounded-full"  src="/images/avatar-michelle.jpg"  />
                <div className="ml-4" > 
                    <p className="text-gray-800 text-sm front-semibold" >Michell Appleton</p>
